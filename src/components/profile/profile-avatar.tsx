...
export const ProfileAvatar = () => {
  return <>
    <Row style={{ alignItems: 'center' }}>
      <Col xs={{ span: 4 }} lg={{ span: 2 }} xl={{ span: 1 }} style={{ margin: '0 15px' }}>
        <Avatar
          style={{ height: '50px', width: '50px' }}
          src="https://joeschmoe.io/api/v1/random" />
      </Col>
      <Col sm={{ span: 9 }} md={{ span: 5 }} xl={{ span: 3 }} lg={{ span: 5 }}>
        <Upload {...props}>
          <Button type="primary">Upload New Picture</Button>
        </Upload>
      </Col>
      <Col xs={{ span: 4 }} md={{ span: 6 }} xl={{ span: 6 }} lg={{ span: 2 }} style={{ marginLeft: '10px' }}>
        <Upload>
